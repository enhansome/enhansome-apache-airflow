...
* [Source code](https://github.com/apache/airflow/) ⭐ 46,505 | 🐛 1,864 | 🌐 Python | 📅 2026-08-16 (latest stable release [1.10.12](https://github.com/apache/airflow/tree/1.10.12) ⭐ 46,505 | 🐛 1,864 | 🌐 Python | 📅 2026-08-16)
...
* [Astronomer Platform](https://github.com/astronomerio/astronomer) ⭐ 491 | 🐛 29 | 🌐 Python | 📅 2026-08-15 - Apache Airflow as a Service on Kubernetes. For more information visit <https://www.astronomer.io>.
...
* [Installing Airflow on IBM Cloud](https://github.com/KissConsult/Apache-Airflow) ⭐ 1 | 🐛 0 | 📅 2020-10-13 - Quick and easy deployment on IBM Cloud with IBM [Bitnami Charts](https://github.com/bitnami/charts) ⭐ 10,398 | 🐛 4 | 🌐 Go Template | 📅 2026-08-14
...
* [dlt](https://github.com/dlt-hub/dlt) ⭐ 5,742 | 🐛 416 | 🌐 Python | 📅 2026-08-14 - [data load tool](https://dlthub.com/) is an open-source Python library for building data pipelines with schema inference and incremental loading. Includes an [Airflow helper](https://dlthub.com/docs/walkthroughs/deploy-a-pipeline/deploy-with-airflow-composer) to convert dlt pipelines into Airflow DAGs/TaskGroups.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,842 | 🐛 11 | 🌐 Go | 📅 2026-08-15 - CLI tool to copy data between any source and destination with a single command. Use with BashOperator to load data from 50+ sources (Postgres, MongoDB, Salesforce, etc.) into your warehouse.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,666 | 🐛 31 | 🌐 Go | 📅 2026-08-15 - Data ingestion and transformation layer with SQL and Python support. Ingests from 50+ sources (like Airbyte/Fivetran) and transforms (like dbt). Can be triggered from Airflow DAGs or run standalone. Includes built-in data quality checks.
...
* [whirl](https://github.com/godatadriven/whirl) ⭐ 205 | 🐛 7 | 🌐 Shell | 📅 2026-08-12 - Fast iterative local development and testing of Apache Airflow workflows.
...
* [airflow-config](https://github.com/airflow-laminar/airflow-config) ⭐ 17 | 🐛 7 | 🌐 Python | 📅 2026-08-16 - [Pydantic](https://pydantic.dev) / [Hydra](https://hydra.cc) based configuration system for DAG and Task arguments
