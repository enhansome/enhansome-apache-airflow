...
* [Source code](https://github.com/apache/airflow/) ⭐ 46,930 | 🐛 2,131 | 🌐 Python | 📅 2026-09-21 (latest stable release [1.10.12](https://github.com/apache/airflow/tree/1.10.12) ⭐ 46,930 | 🐛 2,131 | 🌐 Python | 📅 2026-09-21)
...
* [Astronomer Platform](https://github.com/astronomerio/astronomer) ⭐ 490 | 🐛 29 | 🌐 Python | 📅 2026-09-21 - Apache Airflow as a Service on Kubernetes. For more information visit <https://www.astronomer.io>.
...
* [Installing Airflow on IBM Cloud](https://github.com/KissConsult/Apache-Airflow) ⭐ 1 | 🐛 0 | 📅 2020-10-13 - Quick and easy deployment on IBM Cloud with IBM [Bitnami Charts](https://github.com/bitnami/charts) ⭐ 10,410 | 🐛 6 | 🌐 Go Template | 📅 2026-09-21
...
* [dlt](https://github.com/dlt-hub/dlt) ⭐ 5,878 | 🐛 440 | 🌐 Python | 📅 2026-09-21 - [data load tool](https://dlthub.com/) is an open-source Python library for building data pipelines with schema inference and incremental loading. Includes an [Airflow helper](https://dlthub.com/docs/walkthroughs/deploy-a-pipeline/deploy-with-airflow-composer) to convert dlt pipelines into Airflow DAGs/TaskGroups.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,969 | 🐛 23 | 🌐 Go | 📅 2026-09-21 - CLI tool to copy data between any source and destination with a single command. Use with BashOperator to load data from 50+ sources (Postgres, MongoDB, Salesforce, etc.) into your warehouse.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,710 | 🐛 61 | 🌐 Go | 📅 2026-09-21 - Data ingestion and transformation layer with SQL and Python support. Ingests from 50+ sources (like Airbyte/Fivetran) and transforms (like dbt). Can be triggered from Airflow DAGs or run standalone. Includes built-in data quality checks.
* [dag-factory](https://github.com/ajbosco/dag-factory) ⭐ 1,460 | 🐛 79 | 🌐 Python | 📅 2026-09-21 - A library for dynamically generating Apache Airflow DAGs from YAML configuration files.
