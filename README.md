...
* [Source code](https://github.com/apache/airflow/) ⭐ 46,630 | 🐛 1,986 | 🌐 Python | 📅 2026-08-28 (latest stable release [1.10.12](https://github.com/apache/airflow/tree/1.10.12) ⭐ 46,630 | 🐛 1,986 | 🌐 Python | 📅 2026-08-28)
...
* [Installing Airflow on IBM Cloud](https://github.com/KissConsult/Apache-Airflow) ⭐ 1 | 🐛 0 | 📅 2020-10-13 - Quick and easy deployment on IBM Cloud with IBM [Bitnami Charts](https://github.com/bitnami/charts) ⭐ 10,407 | 🐛 8 | 🌐 Go Template | 📅 2026-08-27
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,901 | 🐛 27 | 🌐 Go | 📅 2026-08-28 - CLI tool to copy data between any source and destination with a single command. Use with BashOperator to load data from 50+ sources (Postgres, MongoDB, Salesforce, etc.) into your warehouse.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,678 | 🐛 58 | 🌐 Go | 📅 2026-08-28 - Data ingestion and transformation layer with SQL and Python support. Ingests from 50+ sources (like Airbyte/Fivetran) and transforms (like dbt). Can be triggered from Airflow DAGs or run standalone. Includes built-in data quality checks.
